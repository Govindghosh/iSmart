      ...
      <Dialog as="div" className="relative z-50" onClose={onClose}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4">
            ...
            >
              <Dialog.Panel className="relative w-full max-w-md sm:max-w-lg transform overflow-hidden rounded-2xl border border-purple-200 dark:border-purple-600 bg-white dark:bg-gray-900 p-6 shadow-xl transition-all">
                {/* Close Button */}
                <button
                  onClick={onClose}
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-800 rounded-lg px-3 py-2 text-sm text-gray-800 dark:text-gray-100 shadow-sm focus:ring-2 focus:ring-purple-500 outline-none"
                ...
                <div className="flex justify-end gap-3 pt-6">
                  <button
                    onClick={onClose}
                    className="px-4 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-500 text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700"
                  >
                    Cancel
                  </button>
                  <button
