  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <div className="flex items-center gap-3 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-2xl px-4 py-3 shadow-sm">
          ...
          <input
            ...
            className="flex-1 bg-transparent placeholder:text-gray-400 dark:placeholder:text-gray-500 text-sm outline-none"
      ...
      <div>
        ...
        <div className="flex items-center gap-3 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-2xl px-4 py-3 shadow-sm">
          ...
          <input
            ...
            value={formData.code}
            onChange={handleChange}
            className="flex-1 bg-transparent uppercase placeholder:text-gray-400 dark:placeholder:text-gray-500 text-sm outline-none"
            placeholder="e.g. RND"
          />
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex items-start gap-3 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-2xl px-4 py-3 shadow-sm">
          ...
          <textarea
            ...
            onChange={handleChange}
            className="flex-1 bg-transparent resize-none placeholder:text-gray-400 dark:placeholder:text-gray-500 text-sm outline-none"
