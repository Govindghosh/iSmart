...
const DepartmentCard = ({ department, onEdit }) => {
  ...
  const { employees, empStatus, empError, total } =
  ...
  return (
    <>
      <div className="relative w-full sm:max-w-md bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-700 rounded-2xl p-6 shadow-md hover:shadow-xl hover:border-purple-200 dark:hover:border-purple-400 transition-transform duration-300 hover:scale-[1.02]">
        {/* ⋮ Menu */}
          ...
          <AnimatePresence>
            {menuOpen && (
              <motion.div
                ...
                className="absolute right-0 mt-2 w-40 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-xl py-1 z-50"
              >
                <button
                ...
                <button
                  ...
                  className="flex items-center gap-2 w-full text-left px-4 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/30"
                >
        ...
        <div className="flex items-center gap-3 mb-2">
          <div className="p-2 bg-gradient-to-r from-purple-100 via-purple-50 to-white dark:from-purple-900 dark:via-purple-800 dark:to-gray-900 rounded-full shadow-sm">
        ...
        {/* Members */}
        <div
          className="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300 cursor-pointer hover:text-purple-700 dark:hover:text-purple-400 transition"
