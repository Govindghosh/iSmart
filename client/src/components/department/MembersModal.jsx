  ...
  return (
    <Dialog open={isOpen} onClose={onClose} className="relative z-50">
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <Dialog.Panel className="w-full max-w-3xl bg-white dark:bg-gray-900 dark:border dark:border-gray-700 rounded-2xl shadow-xl p-6 overflow-y-auto max-h-[80vh]">
          {/* Header */}
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            {/* Search */}
            <div className="flex items-center w-full sm:max-w-sm border border-gray-300 dark:border-gray-600 rounded-xl px-4 py-2 bg-white dark:bg-gray-800 shadow-sm">
              <FiSearch className="text-gray-400 dark:text-gray-300 mr-2 text-lg" />
              <input
                type="text"
                placeholder={`Search ${title}`}
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
                className="flex-1 text-sm bg-transparent placeholder-gray-400 dark:placeholder-gray-500 text-gray-800 dark:text-white outline-none"
              />
            </div>
              ...
              {totalPages > 1 && (
                <div className="flex items-center justify-center gap-2 mt-6">
                  <button
                    ...
                    className={`px-3 py-1 rounded-lg border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-700 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 transition flex items-center gap-1 ${
                    ...
                    <button
                      ...
                      className={`px-3 py-1 rounded-lg border ${
                        currentPage === idx + 1
                          ...
                          : "bg-white dark:bg-gray-800 text-gray-700 dark:text-white border-gray-200 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700"
                      } transition`}
                    >
                      {idx + 1}
                    </button>
