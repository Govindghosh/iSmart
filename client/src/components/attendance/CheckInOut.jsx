...
const CheckInOut = ({ setCameraData }) => {
  ...
  return (
    <div className="w-full bg-gradient-to-br from-slate-100/60 to-white/90 dark:from-zinc-700/60 dark:to-zinc-800/90 p-6 rounded-2xl shadow-xl border border-slate-200 dark:border-zinc-600 space-y-6">
      <h3 className="text-center text-xl font-bold tracking-widest uppercase text-indigo-600 dark:text-indigo-300">
