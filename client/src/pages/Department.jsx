      ...
      <div className="px-6 py-8 md:p-12 max-w-6xl mx-auto w-full">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl md:text-3xl font-bold text-gray-800 dark:text-gray-100 uppercase tracking-wider">
              Departments
            </h1>
          </div>
          <button
          ...
          <Dialog as="div" className="relative z-50" onClose={closeModal}>
            ...
            <div className="fixed inset-0 overflow-y-auto">
              <div className="flex min-h-full items-center justify-center p-4">
                ...
                >
                  <Dialog.Panel className="relative w-full max-w-xl transform overflow-hidden rounded-2xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 p-6 shadow-xl transition-all">
                    
                    {/* ✖️ Close Button */}
                    <button
                      onClick={closeModal}
                      className="absolute top-4 right-4 text-gray-500 hover:text-red-500 transition dark:text-gray-400"
                      title="Close"
                    >
